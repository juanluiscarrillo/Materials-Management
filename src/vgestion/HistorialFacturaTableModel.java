 ...
 * @author Juan Luis
 */
public class HistorialFacturaTableModel extends javax.swing.table.AbstractTableModel{
    Vector columnNames = new Vector();
    Vector vFactura;
     
    public HistorialFacturaTableModel(Vector vFactura) {
        this.vFactura = vFactura;   
    }
    
    public HistorialFacturaTableModel() {
